...
/// This test verifies that the genesis builder correctly ensures genesis verifier result.
#[test]
#[should_panic = "invalid genesis currency swap related data"]
fn genesis_ensure_genesis_verifier() {
    with_runtime_lock(|| {
        ...
        let genesis_config = mock::GenesisConfig::default();
    ...
    with_runtime_lock(|| {
        ...
        new_test_ext().execute_with(|| {
            ...
            swap_ctx
                ...
                .return_once(move |_| {
                    Ok(
                        <EvmBalances as Currency<EvmAccountId>>::NegativeImbalance::new(
                            swap_balance,
                        ),
                    )
                });
